...
We set the input graph as (1) adjacency matrix $A$, (2) \textit{refined adjacency matrix} $A'$ to compare their performance and illustrate the effect of road correlation in traffic state prediction. The corresponding models are denoted as STGCN-$A$, STGCN-$A'$, DCRNN-$A$ and DCRNN-$A'$.
    ...
    \begin{center}
        ...
        \resizebox{\textwidth}{!}{
            \begin{tabular}{c|c|ccc|ccc|ccc}
                ...
                \multirow{4}{*}{Flow} & STGCN-$A$ & $4.44$ & $3.46$ & $33.00\%$ & $4.64$ & $3.57$ & $33.64\%$ & $5.07$ & $3.88$ & $36.07\%$\\
                ~ & STGCN-$A'$ & $4.43$ & $3.43$ & $32.52\%$ & $\mathbf{4.61}$ & $\mathbf{3.54}$ & $\mathbf{33.23}\%$ & $4.98$ & $3.78$ & $35.31\%$\\
                ...
                \multirow{4}{*}{Speed} & STGCN-$A$ & $6.60$ & $4.65$ & $23.67\%$ & $6.63$ & $4.66$ & $24.22\%$ & $6.71$ & $4.74$ & $24.01\%$\\
                ~ & STGCN-$A'$ & $\mathbf{6.60}$ & $\mathbf{4.65}$ & $\mathbf{23.66\%}$ & $\mathbf{6.62}$ & $\mathbf{4.67}$ & $\mathbf{23.79\%}$ & $\mathbf{6.67}$ & $\mathbf{4.72}$ & $\mathbf{24.00\%}$\\
